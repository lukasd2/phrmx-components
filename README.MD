# This branch is not maintaned and should not be build upon. It was configured to manage content from 2 APIs (pexels + local). Branch used for presentation made for dissertation on 05/06/21. 
